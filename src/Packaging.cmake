...
MACRO(SharemindPackagingDebAlternateHandling part allowAlternatives)
    ...
    IF(NOT ("${${p}_DEB_${part}}" STREQUAL ""))
        ...
        FOREACH(d IN LISTS "${p}_DEB_${part}")
            ...
            IF("${DEB_${part}}" STREQUAL "")
                IF("${allowAlternatives}" AND ("${d}" MATCHES "^\\|"))
...
FUNCTION(SharemindAddComponentPackage_ component)
    ...
    FOREACH(generator IN LISTS CPACK_GENERATOR)
        IF("${generator}" STREQUAL "DEB")
            ...
            SharemindPackagingDebAlternateHandling(BREAKS FALSE)
            SharemindPackagingDebAlternateHandling(CONFLICTS FALSE)
            SharemindPackagingDebAlternateHandling(DEPENDS TRUE)
            SharemindPackagingDebAlternateHandling(ENHANCES FALSE)
            SharemindPackagingDebAlternateHandling(PREDEPENDS TRUE)
            SharemindPackagingDebAlternateHandling(PROVIDES FALSE)
            SharemindPackagingDebAlternateHandling(RECOMMENDS TRUE)
            SharemindPackagingDebAlternateHandling(REPLACES FALSE)
            SharemindPackagingDebAlternateHandling(SUGGESTS TRUE)
